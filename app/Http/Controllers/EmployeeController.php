...
class EmployeeController extends Controller
{
    ...
    public function update(Request $request, Employee $employee)
    {
        $request->validate(
            ...
            [
                ...
                'unit_kerja.required' => 'Kolom Unit Kerja tidak boleh kosong',
                'jabatan.required' => 'Kolom Jabatan tidak boleh kosong',
                'foto.required' => 'Silahkan pilih file foto',
                'foto.mimes' => 'Tipe File harus JPG/JPEG',
                'foto.max' => 'Ukuran file tidak boleh dari 10 MB',
            ],
        );
        if ($request->hasFile('foto')) {
        ...
        return redirect()
            ->route('employee.index')
            ->with('success', 'Ubah Data Employee sudah berhasil disimpan');
    }
    ...
    public function destroy(Employee $employee)
    {
        ...
        return redirect()
            ->route('employee.index')
            ->with('success', 'Data Employee sudah berhasil dihapus');
    }
}
