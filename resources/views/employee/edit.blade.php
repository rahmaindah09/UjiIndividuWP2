                        ...
                        <div class="col px-5">
                            ...
                            <div class="py-2">
                                ...
                                <input type="text" name="telepon"
                                    ...
                                    placeholder="Masukkan Telepon" value="{{ $employee->telepon }}">
                            ...
                            <div class="py-2">
                                <label class="fw-bold" for="pendidikan">Pendidikan <span
                            ...
                            <div class="py-2">
                                ...
                                <input type="text" name="jabatan"
                                    ...
                                    placeholder="Masukkan Nama" value="{{ $employee->jabatan }}">
                        ...
                        <div class="col px-5">
                            <div class="py-2">
                                ...
                                <input type="date" name="tgl_lahir"
                                    ...
                                    placeholder="Masukkan Tanggal Lahir" value="{{ $employee->tgl_lahir }}">
                            ...
                            <div class="py-2">
                                <label class="fw-bold" for="unit_kerja">Unit Kerja <span
                                        class="text-danger">*)</span></label>
